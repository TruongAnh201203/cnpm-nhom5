...
@section('content')
            ...
            <div class="col-lg-3 col-md-12">
                    ...
                    <div class="layere_categorie">
                        <ul>
                            @foreach ($categories as $category)
                                <li>
                                    <input id="acces" type="checkbox" value="{{$category->brand }}" selected>
                ...
                <div class="sidebar_widget price">
                    ...
                    <form action="" id="filter">
                        ...
                        <button type="submit" class="loc" id="loc">Lọc</button>
                    </form>
                </div>
                <!--price slider end-->
                    ...
                    @foreach ($specials as $special)
                        <div class="special_product_inner mb-20">
                            ...
                            <div class="small_p_desc">
                                ...
                                <h3><a
                                        href="{{ route('shop.singleProduct', $special->idProduct) }}">{{ $special->idProduct }}</a>
                                </h3>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="single_product">
                                                <div class="product_thumb">
                                                    ...
                                                    <div class="img_icone">
                                                        <img src="{{ asset('assets\img\cart\span-new.png') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="product_action">
                                                        <a
                                                            href="{{ route('user.addCart', ['idProduct' => $product->idProduct]) }}">
                                                ...
                                                <div class="product_info">
                                                    <ul>
                                                        ...
                                                        <li><a href="#" data-toggle="modal"
                                                                data-target="#modal_box" title="Quick view">Xem chi
                                                                tiết</a></li>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6">
                                                <div class="product_thumb">
                                                    <a href="{{ route('shop.singleProduct', $product->idProduct) }}"><img
                                                            src="{{ asset($product->imgProduct) }}" alt=""></a>
                                                    <div class="hot_img">
                                                        <img src="{{ asset('assets\img\cart\span-hot.png') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-8 col-md-6 col-sm-6">
                                                <div class="list_product_content">
                                                    ...
                                                    <p class="design"> in quibusdam accusantium qui nostrum consequuntur,
                                                        officia,
                                                        quidem ut placeat. Officiis, incidunt eos recusandae! Facilis
                                                        aliquam
                                                        vitae
    ...
    {{-- <div id="post-list"> a </div> --}}
    <script>
        $("#loc").click(function(e) {
            e.preventDefault();

            $.ajax({
                url: "/shop/Filter/List",
                method: "POST",
